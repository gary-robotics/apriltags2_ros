...
import cv2
import numpy as np
from localization_msgs.msg import StopPoint
from localization_msgs.msg import StopPoints
...
def novatel_callback(inspvax)
    inspvax.latitude
if __name__ == '__main__':
    rospy.init_node('save localization', anonymous=True)
    rospy.Subscriber('/novatel_data/inspvax', INSPVAX, novatel_callback)
    rospy.Subscriber('/tag_localization', StopPoints, tag_callback)
