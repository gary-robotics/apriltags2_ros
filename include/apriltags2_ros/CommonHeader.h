...
struct CommonHeader_
{
  ...
  enum {
    RECEIVER_STATUS_ERROR = 1u,
    RECEIVER_STATUS_TEMPERATURE_WARNING = 2u,
    RECEIVER_STATUS_VOLTAGE_SUPPLY_WARNING = 4u,
    RECEIVER_STATUS_ANTENNA_UNPOWERED = 8u,
    RECEIVER_STATUS_LNA_FAILURE = 16u,
    RECEIVER_STATUS_ANTENNA_OPEN = 32u,
    RECEIVER_STATUS_ANTENNA_SHORTED = 64u,
    RECEIVER_STATUS_CPU_OVERLOADED = 128u,
    RECEIVER_STATUS_COM1_BUFFER_OVERRUN = 256u,
    RECEIVER_STATUS_COM2_BUFFER_OVERRUN = 512u,
    RECEIVER_STATUS_COM3_BUFFER_OVERRUN = 1024u,
    RECEIVER_STATUS_LINK_OVERLOAD = 2048u,
    RECEIVER_STATUS_AUX_TRANSMIT_OVERRUN = 8192u,
    RECEIVER_STATUS_AGC_OUT_OF_RANGE = 16384u,
    RECEIVER_STATUS_INS_RESET = 65536u,
    RECEIVER_STATUS_ALMANAC_INVALID = 262144u,
    RECEIVER_STATUS_POSITION_SOLUTION_INVALID = 524288u,
    RECEIVER_STATUS_POSITION_NOT_FIXED = 1048576u,
    RECEIVER_STATUS_CLOCK_STEERING_DISABLED = 2097152u,
    RECEIVER_STATUS_CLOCK_MODEL_INVALID = 4194304u,
    RECEIVER_STATUS_EXTERNAL_OSCILLATOR_LOCKED = 8388608u,
    RECEIVER_STATUS_SOFTWARE_RESOURCE_WARNING = 16777216u,
    RECEIVER_STATUS_AUXILIARY3_EVENT = 536870912u,
    RECEIVER_STATUS_AUXILIARY2_EVENT = 1073741824u,
    RECEIVER_STATUS_AUXILIARY1_EVENT = 2147483648u,
  };
...
// {'nav_msgs': ['/opt/ros/kinetic/share/nav_msgs/cmake/../msg'], 'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'actionlib_msgs': ['/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg'], 'novatel_msgs': ['/home/trunk/catkin_ws/src/novatel_span_driver/novatel_msgs/msg']}
...
struct MD5Sum< ::novatel_msgs::CommonHeader_<ContainerAllocator> >
{
  ...
  {
    return "494e77bac04f74a099ad631ab2cec829";
  }

  static const char* value(const ::novatel_msgs::CommonHeader_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x494e77bac04f74a0ULL;
  static const uint64_t static_value2 = 0x99ad631ab2cec829ULL;
};
